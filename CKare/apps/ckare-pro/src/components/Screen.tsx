...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.coral, fontSize: 12, fontWeight: "700", letterSpacing: 1.4, textTransform: "uppercase" },
  title: { color: colors.ink, fontFamily: "Georgia", fontSize: 34, lineHeight: 39 },
});
